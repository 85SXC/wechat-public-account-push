export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb4eee0552c1a67f6",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "db919fa55a71577eb0d8003f01787026",
  ...
  USERS: [
    {
      ...
      id: "oWPAa64aHh3zRv9A3kEvzD5qzVAA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "oWPAa64aHh3zRv9A3kEvzD5qzVAA",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "罗甸",
      ...
      festivals: [
        ...
        {"type": "*生日", "班妮": "老婆", "year": "1999", "date": "04-25"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "范玥婧": "老公", "year": "1999", "date": "06-28"},
